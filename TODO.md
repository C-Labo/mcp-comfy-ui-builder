...
- **Phase 7** — CI/CD for automated Docker image publishing
- **Phase 7.2** — Plugin marketplace, `install_plugin(url)`, versioning
- **Phase 9** — Node usage statistics (optional)
- **Phase 10** — QoL: workflow validation, template inheritance, export/import

---

## Links

- [IMPROVEMENT-PLAN.md](IMPROVEMENT-PLAN.md) — Phases 7–10
- [CHANGELOG.md](CHANGELOG.md) — Version history
- [ROADMAP.md](ROADMAP.md) — Timeline
- [doc/INDEX.md](doc/INDEX.md) — Documentation
